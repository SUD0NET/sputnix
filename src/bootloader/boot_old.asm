...
boot_ukern:
    ...
    mov es, ax           ; set extra segment to load address
    xor bx, bx           ; reset BX (offset in segment)
    ...
    jc load_error        ; jump if carry flag is set (read failed)

    ; jump to kernel
    jmp 0x1000:0x0000    ; segment:offset (where kernel was loaded)
